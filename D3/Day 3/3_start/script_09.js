...
// In this activity, we will plot the hair length of 
// heavy metal bands from the 1980s versus their number 
// of Billboard hits. The numbers in the dataset are made up. The bands themselves are very real.
...
//   Use the time well! It is suggested that you 
//   work on one visual element before moving on
//    to the next. Use the first ten minutes to 
//    create the axes and axis labels.
...
d3.csv("./data/hairData.csv", function(err, hairData) {
  if (err) throw err;
